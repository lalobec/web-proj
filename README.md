# CraftPly Woodworks - Custom Furniture Website

A modern, responsive website for a custom plywood furniture business specializing in kitchen cabinetry. Built with vanilla HTML, CSS, and JavaScript for optimal performance and easy customization.
...
Find and replace all instances of "CraftPly" with your business name:
```html
<!-- Line ~13 -->
<title>Your Business Name | Custom Kitchen Cabinetry & Furniture</title>
...
- Email: Search for `hello@craftply.com`
- Service area: Search for "Greater Metro Area"
- Hours of operation
...
<script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "name": "CraftPly Woodworks",
  "image": "https://yoursite.com/logo.jpg",
  "description": "Custom kitchen cabinetry and plywood furniture",
...
```html
<!-- Add to <head> -->
<meta property="og:title" content="CraftPly Woodworks - Custom Kitchen Cabinetry">
<meta property="og:description" content="Expert custom kitchen cabinetry and plywood furniture built to last.">
...
<meta name="twitter:title" content="CraftPly Woodworks">
<meta name="twitter:description" content="Custom kitchen cabinetry built to last">
...
2. Drag and drop the `custom-furniture-site` folder
...
- **Design**: Custom design for CraftPly Woodworks
...
**Built with ❤️ for custom furniture craftsmen**
